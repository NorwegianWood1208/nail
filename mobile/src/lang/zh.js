export default {
  ...
  Github  : 'Github开源代码数据实时更新，NAIL商学院建立，NAIL线下交流会所 ',
  free:'（持有一定数量免费）',
  multidimensionally: 'NAIL孵化基地，NAIL市值管理团队，NAIL多维度全方位的打造世界顶级项目。',
  supported  : '首个多国家支持数字资产项目',
  ecol  : 'NAIL生态涉及到投融资平台、媒体宣传平台、区块链项目孵化平台、交易所、商学院等，',
  blockchain  : '所有这些业务的参与都需要多个国家相互支持为前提，而NAIL就是最好的选择。',
  Investment  : '投融资平台',
  platform : '国家级媒体宣传平台',
  Blockchain  : '区块链孵化平台',
  Great  : '20个主权国家鼎力支持',
  sovereign : '20个主权合作国家分别是：',
  Malaysia : '20个主权合作国家分别是：日本、韩国、蒙古、美国、新加坡、中国、马来西亚、加拿大、印度、吉尔吉斯斯坦、乌兹别克斯坦、哈萨克斯坦、俄罗斯、布里亚特、印尼、越南、泰国、菲律宾、阿塞拜疆、白俄罗斯、英国',
  landmark  : '10个区块链地标建筑',
  follows  : '即将建设区块链地标的国家分别是：',
  United  : '日本、韩国、蒙古、新加坡、中国、马来西亚、加拿大、吉尔吉斯斯坦、美国、俄罗斯',
