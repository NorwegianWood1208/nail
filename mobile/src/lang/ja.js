export default {
  ...
  Sign:'私の時事通信に登録する',
  password : 'パスワード',
  forget_the_password : 'パスワードを忘れる',
  Strategic :'戦略目標 ',
  ecological :'NAILの強力なエコロジーインキュベーション',
  ecology : '汎生態学ブロック鎖インキ',
  Alliance:'ュベーションアライアンス',
  ...
  Github  : 'githubは、ソースコードのデータがリアルタイムで更新され、nail商学院が設立し、nail線下交流会で',
  free  : '(一定数量のフリーを保有している)、nailの基地、nail市の値管理チーム、nailは、全方向性の全面的な世界最高のプロジェクトを構築する。',
  multidimensionally: 'nailは、全方向性の全面的な世界最高のプロジェクトを構築する。',
  supported  : '初の多国はデジタル資産を支援する。',
  ecol  : 'ナイル生态系は、投资プラットフォーム、メディアの宣伝プラットフォーム',
  blockchain  : ' 、ブロックチェーンプロジェクトのためのプラットフォーム、取引所、商业学院など、すべての业务の参加には、复数の国の相互援助を前提にしており、nailは最高の选択である。',
  Investment  : '融資プラットフォーム',
  platform : '国家レベルのメディアの宣伝プラットフォーム。',
  Blockchain  : 'ブロックチェーン化プラットフォーム',
  Great  : '20ヵ国の主権国、支援',
  sovereign : '20カ国の主権協力国は、日本、韓国、モンゴル、米国、シンガポール、中国、マレーシア、カナダ、 ',
  Malaysia : 'インド、キルギスタン、カザフスタン、ロシア、ブリティット、インドネシア、ベトナム、タイ、フィリピン、アゼルバイジャン、ベラルーシ、英国である',
  landmark  : '10個のブロックをブロックします',
  follows  : 'ブロックチェーンを建設する国は日本、韓国、モンゴル、シンガポール、中国、',
  United  : 'ブロックチェーンを建設する国は日本、韓国、モンゴル、シンガポール、中国、マレーシア、カナダ、キルギスタン、米国、ロシア。',
